    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="#"><img src="{{ URL::asset('assets/images/logonew.png') }}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="#"><img src="{{ URL::asset('assets/images/logomini.png') }}" alt="logo" /></a>
        </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="{{ URL::asset('assets/images/faces/face21.jpg') }}" alt="profile">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/kurir') }}">
