                    ...
                    <form action="{{ route('buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                                <option disabled selected>"{{ old('kategori_id', $buku->kategori->kategori) }}"</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" value="{{ old('deskripsi', $buku->deskripsi) }}" placeholder="Masukkan Deskripsi Buku">
